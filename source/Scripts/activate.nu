...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\LENOVO\Documents\Python\chatbot-task\source'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\LENOVO\Documents\Python\chatbot-task\source\Scripts\deactivate.nu'
